...
void citire(char in[256])
{
    ...
    else
    {
        ...
        else if(intrare[0].sir=="mv") //find -r C: *
        {
            CopyFile(intrare[1].sir,intrare[2].sir);
            sterg(intrare[1].sir);
        ...
        else if(intrare[0].sir=="find") /// find -r C: .*txt
        {
            if(intrare[1].sir=="-r")
            {
                if(intrare[3].sir[1]=='*')
                {char aux[256];int loc=-1;
                for(int i=2;i<intrare[3].sir.length();i++)
                {
                    loc++; aux[loc]=intrare[3].sir[i];
                }
                aux[loc+1]=NULL;
             ...
             else if(intrare[1].sir[1]=='d')
             {
               ...
               loc++; aux[loc]=intrare[3].sir[i];  }
                ...
                else {int adc=intrare[1].sir[3]-48;
